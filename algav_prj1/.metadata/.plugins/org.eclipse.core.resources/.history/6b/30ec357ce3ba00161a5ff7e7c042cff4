...
public class Calculation2 {
	...
	public static double deleteWordsHybride(HybridesTries h,ArrayList<String> words){
		...
		//System.out.println(Ajout.liste(h).size());
		 ...
		 for(int cpt = 0; cpt < NTESTS; cpt++){
			 long avant = System.currentTimeMillis();
			 newh = h;
			// System.out.println("hybride:" + cpt+ ":" + Ajout.liste(newh));
			...
			System.out.println("hybride:" + Ajout.liste(newh));

		 moyenne = temps_total / (double) NTESTS;
		 //System.out.println(Ajout.liste(newh));
         //System.out.println("hybride:" + Ajout.comptageMots(newh));
         //System.out.println("input:" + words.size());
	...
	public static double deleteWordsPatricia(PatriciaTrie p,ArrayList<String> words) 
		...
		System.out.println("initial list:" + p.listeMots());
		System.out.println("words to be deleted:" + words);

		//System.out.println("patricia input:" + words.size());
		//System.out.println("patricia trie size" + p.comptageMots());
		long temps_total = 0;
		double moyenne ;
		IPatriciaTrie newp = null;
		 for(int cpt = 0; cpt < NTESTS; cpt++){
			 newp = p.clone();
			 //System.out.println("patricia:" + cpt+ ":" +p.listeMots());
			 long avant = System.currentTimeMillis();
			 for( String word : words){
		 ...
		 System.out.println("patricia:" +newp.listeMots());
